...
export class ZoDepositoryTestSuiteParameters {
...
export const zoDepositoryIntegrationSuite = (authority: Signer, user: Signer, controller: Controller, depository: ZoDepository, params: ZoDepositoryTestSuiteParameters) => {
    let zo: Zo;
    ...
    it(`Initialize ${depository.collateralMintSymbol} ZoDepository`, async () => {
        await initializeZoDepositoryTest(authority, controller, depository, zo);
    });
