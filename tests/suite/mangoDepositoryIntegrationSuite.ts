...
export const mangoDepositoryIntegrationSuite = (authority: Signer, user: Signer, controller: Controller, depository: MangoDepository, params: MangoDepositoryTestSuiteParameters) => {
    ...
    it("Initialize Controller", async () => {
        console.log(depository.getCollateralPerpTakerFees(mango));
    });
    ...
    //     const polarity = unrealizedPnl.isPos ? PnLPolarity.Positive : PnLPolarity.Negative;
    //     const mintedAmount = await rebalanceMangoDepositoryLiteTest(50, polarity, params.slippage, user, controller, depository, mango, bank);
