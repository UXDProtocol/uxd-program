...
import { rebalanceMangoDepositoryTest } from "../cases/rebalanceMangoDepositoryTest";
...
export const mangoDepositoryIntegrationSuite = (authority: Signer, user: Signer, controller: Controller, depository: MangoDepository, params: MangoDepositoryTestSuiteParameters) => {
    ...
    it("Rebalance 100", async () => {
        await rebalanceMangoDepositoryTest(100, 20, user, controller, depository, mango, bank);
    });
