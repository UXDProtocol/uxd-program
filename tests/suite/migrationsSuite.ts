...
export const migrationsSuite = (authority: Signer, controller: Controller, depository: MangoDepository) => {
    it(`Migrates ${depository.collateralMintSymbol} Depository`, async () => {
        await migrateMangoDepositoryToV2Test(authority, controller, depository);
    });
};