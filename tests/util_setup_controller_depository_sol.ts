...
import { authority, USDC, WSOL, uxdProgramId } from "./constants";
import { setupControllerAndMangoDepositorySolSuite } from "./suite/setupControllerAndMangoDepositorySolSuite";

const depositoryWSOL = new MangoDepository(WSOL, "SOL", SOL_DECIMALS, USDC, "USDC", USDC_DECIMALS, uxdProgramId);
