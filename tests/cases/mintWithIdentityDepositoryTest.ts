...
export const mintWithIdentityDepositoryTest = async function ({
    ...
    try {
        ...
        const collateralDelta = Number((userCollateralBalance_pre - userCollateralBalance_post).toFixed(depository.collateralMintDecimals));
        ...
        console.log(
            ...
            "by locking", Number(collateralDelta.toFixed(depository.collateralMintDecimals)), depository.collateralMintSymbol,
        );
        ...
        expect(redeemableDelta)
            .gte(Number((collateralAmount).toFixed(depository.collateralMintDecimals)));
        ...
        expect(nativeToUi(onChainDepository_post.collateralAmountDeposited, depository.collateralMintDecimals))
            .equal(Number((nativeToUi(onChainDepository_pre.collateralAmountDeposited, depository.collateralMintDecimals) + collateralAmount).toFixed(depository.collateralMintDecimals)));
