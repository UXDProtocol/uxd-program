...
const mercurialVaultUSDCCollateralInfo = {
...
describe("Mercurial vault integration tests: USDC", async function () {
    ...
    describe("mercurialVaultDepositorySetupSuite", async function () {
        ...
        mercurialVaultDepositorySetupSuite(authority, bank, controllerUXD, mercurialVaultUSDCCollateralInfo, mintingFeeInBps, redeemingFeeInBps);
    });

    describe("mercurialVaultDepositoryMintRedeemSuite", async function () {
        mercurialVaultDepositoryMintRedeemSuite(authority, user, bank, controllerUXD, mercurialVaultUSDCCollateralInfo);
    });
