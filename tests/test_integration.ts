...
import { createMaplePoolDepositoryDevnetUSDC, transferAllSol, transferSol } from "./utils";
...
import { maplePoolDepositoryMintSuite } from "./suite/maplePoolMintSuite";
import { editMaplePoolDepositorySuite } from "./suite/editMaplePoolDepositorySuite";
...
(async () => {
  ...
  let maplePoolDepository = await createMaplePoolDepositoryDevnetUSDC();
  ...
  describe("Maple pool integration tests: USDC", async function () {
    ...
    describe("editMaplePoolDepositorySuite", function () {
      editMaplePoolDepositorySuite(authority, user, bank, controllerUXD, maplePoolDepository);
    });
  ...
  describe("Mango integration tests: SOL", function () {
    ...
    describe("mangoDepositoryAndControllerAccountingSuite SOL", function () {
      ...
      mangoDepositoryAndControllerAccountingSuite(
        authority,
        user,
        bank,
        controllerUXD,
  ...
  describe.skip("Mango integration tests: BTC", function () {
    ...
    it.skip("mangoDepositoryAndControllerInteractionsSuite BTC", function () {
      const paramsBtc = new MangoDepositoryAndControllerInteractionsSuiteParameters(
        10_000_000,
        30_000,
        1_000_000,
        60_000,
  ...
  describe.skip("Mango integration tests: ETH", function () {
    ...
    describe.skip("mangoDepositoryAndControllerInteractionsSuite ETH", function () {
      const paramsEth = new MangoDepositoryAndControllerInteractionsSuiteParameters(
        10_000_000,
        8_000,
        50_000,
        5_000,
