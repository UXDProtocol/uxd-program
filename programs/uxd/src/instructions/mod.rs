...
pub mod set_mango_depository_mint_and_redeem_fee;
pub mod set_mango_depository_quote_mint_and_redeem_fee;
pub mod set_mango_depository_quote_mint_and_redeem_soft_cap;
...
pub use set_mango_depository_mint_and_redeem_fee::*;
pub use set_mango_depository_quote_mint_and_redeem_fee::*;
pub use set_mango_depository_quote_mint_and_redeem_soft_cap::*;
