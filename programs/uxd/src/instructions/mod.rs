...
pub mod set_mango_depository_regular_mint_fee;
pub mod set_mango_depository_regular_redeem_fee;
...
pub use set_mango_depository_regular_mint_fee::*;
pub use set_mango_depository_regular_redeem_fee::*;
