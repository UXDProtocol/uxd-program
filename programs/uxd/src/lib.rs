...
solana_program::declare_id!("BxYr5TawwhG81hJFrQPyVmcQRhPXfSF759XmhWQH5TKt");
...
pub const CREDIX_LP_DEPOSITORY_LP_SHARES_NAMESPACE: &[u8] = b"CREDIX_LP_DEPOSITORY_LP_SHARES";
