...
solana_program::declare_id!("EEEcv7uxTw2PZqbXSMhNkPbGt7CrP35B7ZrcDSR9vtra");
...
pub mod uxd {
    ...
    #[access_control(ctx.accounts.validate(max_rebalancing_amount, slippage))]
    pub fn rebalance_mango_depository(
        ctx: Context<RebalanceMangoDepository>,
        max_rebalancing_amount: u64,
        slippage: u32,
    ) -> ProgramResult {
        msg!("[rebalance_mango_depository]");
