...
pub const CONTROLLER_SPACE: usize = 8
    ...
    + size_of::<u16>() // credix_lp_depository_marketplace_weight_bps
    + size_of::<Pubkey>() // identity_depository
    + size_of::<Pubkey>() // mercurial_vault_depository
    + size_of::<Pubkey>() // credix_lp_depository_marketplace
    + size_of::<u16>() // credix_lp_depository_receivables_weight_bps
    + size_of::<Pubkey>() // credix_lp_depository_receivables
...
pub struct Controller {
    ...
    // Added receivables new credix pool
