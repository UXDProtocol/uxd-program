...
pub async fn process_initialize_market(
    ...
    let payload = credix_client::instruction::InitializeMarket {
        ...
        _withdraw_epoch_redeem_seconds: 3 * SECONDS_PER_DAY,
        _withdraw_epoch_available_liquidity_seconds: 3 * SECONDS_PER_DAY,
        _withdraw_epoch_request_seconds: 3 * SECONDS_PER_DAY,
    };
