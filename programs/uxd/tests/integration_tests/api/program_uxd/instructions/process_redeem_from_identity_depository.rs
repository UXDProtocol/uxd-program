...
pub async fn process_redeem_from_identity_depository(
    ...
    // Read state before
    let redeemable_mint_before = program_test_context::read_spl_account::<spl_token::state::Mint>(
    ...
    let user_collateral_amount_before = program_test_context::read_spl_account::<
        spl_token::state::Account,
    >(program_test_context, user_collateral)
    .await?
    .amount;
    let user_redeemable_amount_before = program_test_context::read_spl_account::<
        spl_token::state::Account,
    ...
    // Read state after
    let redeemable_mint_after = program_test_context::read_spl_account::<spl_token::state::Mint>(
        program_test_context,
        &program_keys.redeemable_mint,
    )
    .await?;
    ...
    let user_collateral_amount_after = program_test_context::read_spl_account::<
        spl_token::state::Account,
    >(program_test_context, user_collateral)
    .await?
    .amount;
    let user_redeemable_amount_after = program_test_context::read_spl_account::<
        spl_token::state::Account,
    >(program_test_context, user_redeemable)
    .await?
    .amount;
