...
mod test_compute_amount_fraction {
    ...
    fn test_correctness() -> Result<()> {
        ...
        assert_eq!(compute_amount_fraction_floor(0, 900, 100)?, 0);
        ...
        assert_eq!(compute_amount_fraction_floor(100, 900, 100)?, 900);
        ...
        assert_eq!(compute_amount_fraction_floor(10, 900, 100)?, 90);
        ...
        assert_eq!(compute_amount_fraction_floor(1000, 900, 100)?, 9000);
        ...
        assert_eq!(compute_amount_fraction_floor(1000, 10001, 10000)?, 1000);
    ...
    fn test_incorrectness() -> Result<()> {
        ...
        assert!(compute_amount_fraction_floor(u64::MAX, 101, 100).is_err());
        Ok(())
    }
