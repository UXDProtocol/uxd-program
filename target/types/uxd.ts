export type Uxd = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "mangoSolRootBank",
          "isMut": true,
          "isSigner": false
        },
        {
          "name": "mangoSolNodeBank",
          "isMut": true,
          "isSigner": false
        },
        {
  ...
  "errors": [
    ...
    {
      "code": 6055,
      "name": "InvalidNonNativeMintAtaUsed",
      "msg": "Must use native mint for passthrough account"
    },
    {
      "code": 6056,
      "name": "InvalidNonMSolMintAtaUsed",
